...
export default function RefundsPage() {
  return <>
    ...
    <h2>Unpaid orders</h2>
    <p>An order remains pending until payment is confirmed. If you have not paid, no refund is needed and no filing starts. Email <a href="mailto:support@justmyllc.com">support@justmyllc.com</a> with your order reference and ask us to cancel.</p>
    <h2>Before paid work starts</h2>
    <p>You may cancel a paid order before work begins for a full refund of payments we collected, provided no authorized filing or third-party charge has already been incurred. We will confirm the scope, payment terms and authorization to begin before performing paid work.</p>
    <h2>After work or filing starts</h2>
    <p>We refund the unperformed portion of our service and any unspent filing funds. Any deduction for work already performed must be explained and limited to the amount agreed in your order or a separate written agreement. State fees and third-party charges already submitted are refundable only to the extent the recipient returns them or applicable law requires otherwise. We provide an itemized explanation rather than treating every payment as automatically non-refundable.</p>
    ...
    <ol>
      <li>Email <a href="mailto:support@justmyllc.com">support@justmyllc.com</a> with your order reference, purchase email and a description of the issue.</li>
    ...
    <p>This policy does not restrict mandatory cancellation, withdrawal or refund rights under applicable law. Where early performance requires a separate request or acknowledgement, we obtain it before beginning. Placing an order or accepting the general terms does not by itself waive such rights.</p>
  </>;
}
