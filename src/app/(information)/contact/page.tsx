...
export const metadata: Metadata = { title: 'Contact & Support | Just My LLC', description: 'Contact Just My LLC about formation requests, delivery, cancellations, refunds and privacy.' };
export default function ContactPage() {
  return <>
    <h1>Contact & Support</h1>
    <p className="information-intro">Questions about a formation request, documents or a cancellation? Contact Just My LLC directly.</p>
    <a className="btn btn-accent btn-xl" href="mailto:support@justmyllc.com">support@justmyllc.com</a>
    <p>Email support is being configured for launch. Once active, we aim to respond within three business days. Include your request reference, selected state and entity type so we can find your request. For refunds, include your purchase email and a brief description of the issue.</p>
