...
export default function TermsPage() {
  return <>
    ...
    <p className="information-intro">Please read these terms before ordering company formation, EIN or banking assistance.</p>
    <h2>1. Who we are and current availability</h2>
    <BusinessDetails />
    <p>Placing an order saves your selected formation and itemized price as pending payment. You then continue to secure payment without a prior inquiry. We confirm payment through the payment provider before starting fulfillment. An order or payment does not itself create a company; filing also requires complete information and your authorization.</p>
    ...
    <p>We use information to process and fulfill your order and communicate about it as explained in the <Link href="/privacy">Privacy Policy</Link>. Contact <a href="mailto:support@justmyllc.com">support@justmyllc.com</a> for assistance or a complaint. Do not email passwords, payment-card details or identity documents.</p>
    <h2>8. Changes and disputes</h2>
    <p>We may update these terms for future orders. Changes do not retroactively alter an accepted order without your agreement. Contact us first so we can try to resolve a concern. These terms do not impose mandatory arbitration, waive statutory consumer rights or limit access to a competent court or regulator.</p>
  </>;
}
