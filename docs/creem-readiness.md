...
4. Database setup completed: migrations applied and a production order was saved and read successfully. See `docs/payment-setup.md` for the QA reference and evidence. The private variables are sensitive and omitted from CLI downloads.
